...
@interface OPVideoController ()<ProgressDelegate>
...
@implementation OPVideoController
{
...
- (void)creatBtn
{
    ...
    share.frame = CGRectMake(self.view.frame.size.height - 50, 0, 60, 50);
    ...
    play.center = CGPointMake(self.view.frame.size.height/2, self.view.frame.size.width/2);
    ...
    UIView *sliderView = [[UIView alloc]initWithFrame:CGRectMake(0, self.view.frame.size.width - height, self.view.frame.size.height, height)];
    ...
    self.progress = [[Slider alloc]initWithFrame:CGRectMake(progressX, 0, self.view.frame.size.height - progressX * 2, height)];
    ...
    // 4.添加总时长label
    UILabel *end = [[UILabel alloc]initWithFrame:CGRectMake(self.view.frame.size.height - progressX, 0, 60, height)];
    ...
    // 创建自己的音量条
    UISlider *volume = [[UISlider alloc]initWithFrame:CGRectMake(0, 0, self.view.frame.size.height / 3.8, 30)]; // 先让slider横放
    volume.center = CGPointMake(40, self.view.frame.size.width / 2);
