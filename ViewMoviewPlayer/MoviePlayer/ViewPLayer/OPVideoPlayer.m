...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        MPVolumeView *volum = [[MPVolumeView alloc]initWithFrame:CGRectMake(-101, -110, 30, 30)];
...
- (void)playvideo{
    ...
    NSString *string = @"http://pictoshare.net/upload/share/167/低画质1.mp4";
...
//    }
    ...
    [(OPVideoVC *)[self viewController] dismissVc:^(OPVideoVC *pamer) {
        
        [pamer dismissViewControllerAnimated:YES completion:nil];
